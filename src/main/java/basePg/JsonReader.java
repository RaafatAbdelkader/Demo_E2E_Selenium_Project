...
public class JsonReader {
    ...
    public static Object[][] getAllUsersData(List<String> keys){
        FileReader file = null;
        try {
            file = new FileReader(jsonPath);
    ...
    public static Object[][] getDataUsingStatus(List<String> keys, String status){
